...
/**
 * Because the properties of Nano's scan configuration parameters are not very clear, the structure is not very clear, and I think his program is not very good. The most speechless is this
 * I changed it for a day, it's not easy to use, there are always some strange problems. So I decided to scrap this page!
 */
@Deprecated
public class ActiveScanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("gaohui", "Scan type is：" + activeConf.getScanType());
